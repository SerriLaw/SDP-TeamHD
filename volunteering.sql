...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 02, 2014 at 01:52 PM
...
('asd', 'grsadf', 'asdgwreeg', '2014-11-03', '2014-11-07', '0900', '1200', 39, 8, 1);
...
('11655178', 14, '2014-11-02 12:44:02', 0);
...
CREATE TABLE IF NOT EXISTS `event` (
  ...
  `startDate` date NOT NULL,
  `endDate` date NOT NULL,
  `startTime` varchar(4) NOT NULL DEFAULT '0000',
  `endTime` varchar(4) NOT NULL DEFAULT '0000',
  `location` varchar(50) NOT NULL,
...
INSERT INTO `event` (`eventID`, `name`, `description`, `startDate`, `endDate`, `startTime`, `endTime`, `location`, `managerID`, `isActive`) VALUES
(32, 'UTS Open Day', 'This is a fun event', '2014-11-01', '2014-11-08', '900', '1800', 'UTS City Campus', '11111111', 1),
(39, 'Does this work', 'Hope so bruv', '2014-11-02', '2014-11-07', '0901', '1200', 'UTS bruvi', '87654321', 1);
...
(14, 'FEIT Stall Manager', 0, 'Manage the FEIT stall throughout UTS Open Day', 'Good communication skills!', '2014-11-08', '2014-11-01', '1001', '1200', 0, 7, 1),
(21, 'Flyers', 0, 'Hand Out Flyers', 'A smile', '2014-10-31', '2014-10-29', '0900', '1200', 0, 7, 1),
(22, 'adwd ', 0, 'asdw ', 'awdad', '2014-11-18', '2014-11-18', '1111', '1112', 0, 7, 1);
...
('11111111', 'FEIT', 'Marketing'),
('87654321', 'FEI', 'Marketing');
...
('11655178', 'Running', 'Marathon', 'C10143v5'),
('12121212', 'asd w', 'asdw ', 'C10143v5'),
...
('11111111', 'Event', 'Manager', 'mail@events.com', 'events', '0430338161', '1994-02-19', 'f', 3, 1),
('11655178', 'Joshua', 'Killen', 'josh.killen@uts.edu.au', 'barrington1', '0430338161', '1994-02-19', 'm', 0, 1),
('12121212', 'Battle', 'Hard', 'a@a.com', 'password', '1234567890', '2014-11-25', 'f', 0, 1),
('12345678', 'Delete', 'Me', 'd@mail.com', 'test', '0430338161', '1994-11-04', 'f', 0, 0),
('87654321', 'Event', 'Manager', 'mail@events.com', 'events', '0430338161', '1994-02-19', 'f', 2, 1);
